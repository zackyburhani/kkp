...
class C_LapPenilaianCalonKaryawan extends CI_Controller {

	function __construct() {
        parent::__construct();
        $this->load->library('pdf');
        $this->load->model(['M_LapPerangkinganNilai','M_LapRekapitulasiPenilaian','M_LapPenilaianCalonKaryawan']);
    }
    ...
    public function periode(){
        ...
        $data = ['getLapPenilaianCalonKaryawan' => $getLapPenilaianCalonKaryawan,
                'periode' => $periode
	...
	function cetaklaporanrank(){
		...
		$hasil = $this->M_LapPenilaianCalonKaryawan->getLapPenilaianCalonKaryawan($periode);
